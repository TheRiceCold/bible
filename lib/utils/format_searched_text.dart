...
Text formatSearchText({ 
  ...
  // Create a case-insensitive regular expression for the search list
  RegExp regExp =  RegExp(text, caseSensitive: false);

  // Find all matches of the search text inthe input string
  ...
  // Add the remaining non-watching text span
